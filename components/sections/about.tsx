...
import { ArrowRight, Users, Award, Clock, ThumbsUp } from "lucide-react";
    ...
    <section className="py-20 lg:py-32 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center mb-20">
          <AnimatedSection direction="left">
            ...
            <p className="text-lg text-[#64748B] mb-6 leading-relaxed">
              StudioDigital adalah-agency yang berfokus pada pembuatan website profesional untuk UMKM, restoran, kafe, dan bisnis lokal di Indonesia.
            </p>
          ...
          <AnimatedSection direction="right">
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -left-6 bg-white rounded-xl p-4 shadow-xl">
                ...
                <p className="text-sm text-[#64748B]">Tahun Pengalaman</p>
              </div>
            </div>
          </AnimatedSection>
        </div>
        ...
        <AnimatedSection className="mb-16">
          <h3 className="text-2xl sm:text-3xl font-bold text-[#0F172A] text-center mb-12">
            Mengapa Memilih Kami?
          </h3>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {values.map((value, index) => (
              <AnimatedSection key={value.title} delay={index * 100}>
                <div className="p-6 bg-[#F8FAFC] rounded-2xl h-full">
                  <h4 className="text-lg font-semibold text-[#0F172A] mb-3">
                    {value.title}
                  </h4>
        ...
        <AnimatedSection className="text-center">
          <div className="bg-gradient-to-r from-[#2563EB] to-[#06B6D4] rounded-2xl p-8 lg:p-12">
            ...
            <p className="text-white/80 mb-8 max-w-2xl mx-auto">
              Mari diskusikan kebutuhan website Anda dan mulai perjalanan digital bisnis Anda bersama StudioDigital.
            </p>
            <Button
              variant="secondary"
              size="lg"
