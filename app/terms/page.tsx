        ...
        <div className="prose prose-lg max-w-none">
          <div className="bg-[#F8FAFC] dark:bg-slate-800 rounded-2xl p-6 mb-8">
            <p className="text-[#64748B] dark:text-slate-300">
              Dengan menggunakan layanan <strong className="text-[#0F172A] dark:text-white">{siteConfig.name}</strong>, Anda setuju untuk terikat dengan syarat dan ketentuan ini. Silakan baca dengan seksama sebelum menggunakan layanan kami.
            </p>
          </div>

          <h2 className="text-2xl font-bold text-[#0F172A] dark:text-white mt-10 mb-4">1. Penerimaan Syarat</h2>
          ...
          <h2 className="text-2xl font-bold text-[#0F172A] dark:text-white mt-10 mb-4">2. Layanan yang Disediakan</h2>
          <p className="text-[#64748B] dark:text-slate-300 mb-6">
          ...
          <h2 className="text-2xl font-bold text-[#0F172A] dark:text-white mt-10 mb-4">3. Proses Kerja</h2>

          <h3 className="text-xl font-semibold text-[#0F172A] dark:text-white mt-6 mb-3">3.1 Konsultasi Awal</h3>
          <p className="text-[#64748B] dark:text-slate-300 mb-6">
            Kami akan melakukan konsultasi untuk memahami kebutuhan, tujuan, dan ekspektasi Anda terhadap proyek website.
          </p>

          <h3 className="text-xl font-semibold text-[#0F172A] dark:text-white mt-6 mb-3">3.2 Proposal dan Kontrak</h3>
          <p className="text-[#64748B] dark:text-slate-300 mb-6">
          ...
          <h3 className="text-xl font-semibold text-[#0F172A] dark:text-white mt-6 mb-3">3.3 Design dan Development</h3>
          <p className="text-[#64748B] dark:text-slate-300 mb-6">
          ...
          <h3 className="text-xl font-semibold text-[#0F172A] dark:text-white mt-6 mb-3">3.4 Revisi</h3>
          <p className="text-[#64748B] dark:text-slate-300 mb-6">
          ...
          <h3 className="text-xl font-semibold text-[#0F172A] dark:text-white mt-6 mb-3">3.5 Launch</h3>
          <p className="text-[#64748B] dark:text-slate-300 mb-6">
            Setelah persetujuan final dan pelunasan pembayaran, website akan di-launch ke server production dan siap digunakan.
          </p>

          <h2 className="text-2xl font-bold text-[#0F172A] dark:text-white mt-10 mb-4">4. Pembayaran</h2>
          <ul className="list-disc pl-6 mb-6 space-y-2 text-[#64748B] dark:text-slate-300">
          ...
          <h2 className="text-2xl font-bold text-[#0F172A] dark:text-white mt-10 mb-4">5. Hak atas Karya</h2>
          <p className="text-[#64748B] dark:text-slate-300 mb-6">
          ...
          <h2 className="text-2xl font-bold text-[#0F172A] dark:text-white mt-10 mb-4">6. Dukungan dan Maintenance</h2>
          <ul className="list-disc pl-6 mb-6 space-y-2 text-[#64748B] dark:text-slate-300">
          ...
          <h2 className="text-2xl font-bold text-[#0F172A] dark:text-white mt-10 mb-4">7. Garansi</h2>
          <p className="text-[#64748B] dark:text-slate-300 mb-6">
          ...
          <h2 className="text-2xl font-bold text-[#0F172A] dark:text-white mt-10 mb-4">8. Kebijakan Refund</h2>
          <ul className="list-disc pl-6 mb-6 space-y-2 text-[#64748B] dark:text-slate-300">
          ...
          <h2 className="text-2xl font-bold text-[#0F172A] dark:text-white mt-10 mb-4">9. Batasan Tanggung Jawab</h2>
          <p className="text-[#64748B] dark:text-slate-300 mb-6">
          ...
          <h2 className="text-2xl font-bold text-[#0F172A] dark:text-white mt-10 mb-4">10. Kerahasiaan</h2>
          <p className="text-[#64748B] dark:text-slate-300 mb-6">
          ...
          <h2 className="text-2xl font-bold text-[#0F172A] dark:text-white mt-10 mb-4">11. Perubahan Syarat</h2>
          <p className="text-[#64748B] dark:text-slate-300 mb-6">
          ...
          <h2 className="text-2xl font-bold text-[#0F172A] dark:text-white mt-10 mb-4">12. Hukum yang Berlaku</h2>
          <p className="text-[#64748B] dark:text-slate-300 mb-6">
          ...
          <h2 className="text-2xl font-bold text-[#0F172A] dark:text-white mt-10 mb-4">13. Hubungi Kami</h2>
          <p className="text-[#64748B] dark:text-slate-300 mb-6">
