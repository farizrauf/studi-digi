      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="prose prose-lg max-w-none">
          <div className="bg-[#F8FAFC] rounded-2xl p-6 mb-8">
            <p className="text-[#64748B]">
              Di <strong>{siteConfig.name}</strong>, kami sangat menghargai privasi Anda. Kebijakan privasi ini menjelaskan bagaimana kami mengumpulkan, menggunakan, mengungkapkan, dan melindungi informasi pribadi Anda ketika Anda menggunakan layanan kami.
            </p>
          </div>

          <h2 className="text-2xl font-bold text-[#0F172A] mt-10 mb-4">1. Informasi yang Kami Kumpulkan</h2>
          ...
          <ul className="list-disc pl-6 mb-6 space-y-2 text-[#64748B]">
            <li><strong>Nama dan informasi kontak</strong> - saat Anda menghubungi kami atau mengisi formulir</li>
            <li><strong>Informasi proyek</strong> - detail tentang bisnis dan kebutuhan website Anda</li>
            <li><strong>Data komunikasi</strong> - email, pesan WhatsApp, dan catatan komunikasi lainnya</li>
            <li><strong>Data teknis</strong> - alamat IP, jenis browser, dan informasi perangkat</li>
          </ul>

          <h2 className="text-2xl font-bold text-[#0F172A] mt-10 mb-4">2. Bagaimana Kami Menggunakan Informasi</h2>
          <p className="text-[#64748B] mb-6">
          ...
          <h2 className="text-2xl font-bold text-[#0F172A] mt-10 mb-4">3.共享与披露</h2>
          <p className="text-[#64748B] mb-6">
          ...
          <h2 className="text-2xl font-bold text-[#0F172A] mt-10 mb-4">4. Keamanan Data</h2>
          <p className="text-[#64748B] mb-6">
          ...
          <h2 className="text-2xl font-bold text-[#0F172A] mt-10 mb-4">5. Hak Anda</h2>
          <p className="text-[#64748B] mb-6">
          ...
          <h2 className="text-2xl font-bold text-[#0F172A] mt-10 mb-4">6. Cookie dan Teknologi Similar</h2>
          <p className="text-[#64748B] mb-6">
          ...
          <h2 className="text-2xl font-bold text-[#0F172A] mt-10 mb-4">7. Perubahan Kebijakan</h2>
          <p className="text-[#64748B] mb-6">
          ...
          <h2 className="text-2xl font-bold text-[#0F172A] mt-10 mb-4">8. Hubungi Kami</h2>
          <p className="text-[#64748B] mb-6">
